...
public final class ActivityLandingBinding implements ViewBinding {
  ...
  private ActivityLandingBinding(@NonNull LinearLayout rootView, @NonNull Button btnStartSystem) {
  ...
  public static ActivityLandingBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLandingBinding((LinearLayout) rootView, btnStartSystem);
    }
